  ...
  return (
    <div>
      <div className="min-h-full bg-orange-100 px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8 rounded-md">
        ...
        <div className="text-left mt-10 flex items-center">
          <div>It seems that you haven't create a user</div>
          <button onClick={() => router.push("/")}>
            <a className="inline-flex items-center rounded-md border border-transparent bg-transparent px-4 py-2 text-sm font-medium text-red-600 hover:bg-pink-200 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2">
              Create user
            </a>
          </button>
        </div>
